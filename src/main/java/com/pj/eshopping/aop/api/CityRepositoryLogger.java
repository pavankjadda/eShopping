...
public class CityRepositoryLogger {
    private final Logger logger = LoggerFactory.getLogger(CityRepositoryLogger.class);
    ...
    @Pointcut(value = "execution(* com.pj.eshopping.repo.CityRepository.findByNameAndState(..)) && args(name,state,..)", argNames = "name,state")
