...
public class CategoryController {
    ...
    public ResponseEntity<Category> findCategoryById(@PathVariable Long id, HttpServletRequest request) {
        ...
        throw new GenericException(" Category with id:" + id + " is not Found", "", HttpStatus.NOT_FOUND, LocalDateTime.now(), null, request.getRequestURI());
    }
    ...
    public void deleteCategoryById(@PathVariable Long id, HttpServletRequest request) {
        ...
        throw new GenericException("Failed to delete the Category. Category with id:" + id + " is not Found", "", HttpStatus.NOT_FOUND, LocalDateTime.now(),
