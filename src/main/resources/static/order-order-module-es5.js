...
var OrderDeleteComponent = /** @class */ (function () {
    function OrderDeleteComponent() {
    }
    OrderDeleteComponent.prototype.ngOnInit = function () {
    };
...
var OrderHomeComponent = /** @class */ (function () {
    function OrderHomeComponent() {
    }
    OrderHomeComponent.prototype.ngOnInit = function () {
    };
...
var OrderListComponent = /** @class */ (function () {
    ...
    OrderListComponent.prototype.getOrders = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["ORDER_API_URL"] + 'list';
        this.orderService.getOrders(url).subscribe(function (data) {
            _this.orders = data;
        }, function (error) {
    ...
    OrderListComponent.prototype.orderDetailsDataAvailable = function () {
...
var OrderNewComponent = /** @class */ (function () {
    function OrderNewComponent(orderService, productService) {
        this.orderService = orderService;
    ...
    OrderNewComponent.prototype.getProducts = function () {
        var _this = this;
        var productsUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_4__["PRODUCT_API_URL"] + 'list';
        this.productService.getProducts(productsUrl).subscribe(function (data) {
            _this.products = data;
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getOrders = function (url) {
