...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(formBuilder, route, router, authService, registerService) {
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.submitted = true;
        var registerUser = new _register_user__WEBPACK_IMPORTED_MODULE_8__["RegisterUser"]();
        ...
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_9__["environment"].SERVER_URL + 'register';
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpHeaders"]({
                'Content-Type': 'application/json'
            })
        };
        this.registerService.registerUser(url, registerUser, httpOptions).subscribe(function (response) {
            console.log('User Registration Completed  ' + response);
            _this.router.navigate(['/home']);
        }, function (error) { return console.log('error: ' + error); }, function () { return console.log('User Registration Completed '); });
    };
    RegisterComponent.prototype.checkIfMatchingPasswords = function (password, confirmPassword) {
        return function (group) {
            var passwordInput = group.controls[password], passwordConfirmationInput = group.controls[confirmPassword];
...
var RegisterService = /** @class */ (function () {
    ...
    RegisterService.prototype.registerUser = function (url, registerUser, httpOptions) {
...
function usernameValidator() {
    return function (control) {
        var usernamePattern = /^[0-9a-zA-Z0-9]+$/;
...
function confirmPasswordValidator() {
    return function (control) {
        var confirmPasswordPattern = /^[0-9@#$&%!a-zA-Z0-9]+$/;
...
var UserProfileEditComponent = /** @class */ (function () {
    function UserProfileEditComponent(authService, userProfileService, spinnerService, cityService, stateService, countryService, addressTypeService, addressService, router, modalService) {
        this.authService = authService;
    ...
    UserProfileEditComponent.prototype.openModal = function (template, address) {
    ...
    UserProfileEditComponent.prototype.getUserProfile = function () {
        var _this = this;
        var userProfileId = this.authService.currentUserSubject.value.userProfile.id;
        var userProfileUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["USER_PROFILE_API_URL"] + userProfileId;
    ...
    UserProfileEditComponent.prototype.updateUserProfile = function () {
        var _this = this;
        this.spinnerService.show();
        var userProfileUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["USER_PROFILE_API_URL"] + 'update';
        var userProfileId = this.authService.currentUserSubject.value.userProfile.id;
        var userProfile = new _model_user_profile__WEBPACK_IMPORTED_MODULE_2__["UserProfile"]();
        ...
        this.userProfileService.updateUserProfile(userProfileUrl, userProfile).subscribe(function (data) {
            userProfile = data;
    ...
    UserProfileEditComponent.prototype.updateUserAddress = function () {
        var _this = this;
        var addressApiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["ADDRESS_API_URL"] + 'update';
        this.addressService.updateAddress(addressApiUrl, this.userProfileForm.value.address).subscribe(function (data) {
    ...
    UserProfileEditComponent.prototype.deleteAddress = function (address) {
        var _this = this;
        var addressApiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["ADDRESS_API_URL"] + 'delete/' + address.id;
        this.addressService.deleteAddress(addressApiUrl).subscribe(function (data) {
            _this.getUserProfile();
        }, function (error1) {
        });
    };
    UserProfileEditComponent.prototype.loadAddressTypes = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["ADDRESS_TYPE_API_URL"] + 'list';
    ...
    UserProfileEditComponent.prototype.loadCountries = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["COUNTRY_API_URL"] + 'list';
        this.countryService.getCountries(url).subscribe(function (countries) {
            _this.countries = countries;
        }, function (error1) {
        });
    };
    UserProfileEditComponent.prototype.loadStates = function () {
        var _this = this;
        var country = this.userProfileForm.value.address.country;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["STATE_API_URL"] + 'find/country/' + country.id;
    ...
    UserProfileEditComponent.prototype.loadCities = function () {
        var _this = this;
        var state = this.userProfileForm.value.address.state;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_15__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_7__["CITY_API_URL"] + 'find/state/' + state.id;
    ...
    UserProfileEditComponent.prototype.compareAddressTypeFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    UserProfileEditComponent.prototype.compareCountryFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    UserProfileEditComponent.prototype.compareStateFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    UserProfileEditComponent.prototype.compareCityFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    UserProfileEditComponent.prototype.goBack = function () {
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(authService, userProfileService, spinner, router) {
        this.authService = authService;
        this.userProfileService = userProfileService;
    ...
    UserProfileComponent.prototype.getUserProfile = function () {
        var _this = this;
        this.spinner.show();
        var userProfileUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_8__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_3__["USER_PROFILE_API_URL"] + 'my_profile';
        this.userProfileService.getUserProfile(userProfileUrl).subscribe(function (data) {
            _this.userProfile = data;
            _this.userProfileForm.patchValue({
                id: data.id,
    ...
    UserProfileComponent.prototype.userProfileDataAvailable = function () {
        return this.userProfile !== undefined && this.userProfile !== null;
    };
    UserProfileComponent.prototype.goHome = function () {
