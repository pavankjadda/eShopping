...
const addressTypeManagementRoute = [
    {
        path: '',
...
let AddressTypeRoutingModule = class AddressTypeRoutingModule {
};
...
let AddressTypeComponent = class AddressTypeComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
//# sourceMappingURL=address-type-address-type-module-es2015.js.map