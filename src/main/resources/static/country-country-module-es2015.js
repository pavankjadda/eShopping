...
let CountryRoutingModule = class CountryRoutingModule {
};
...
let CountryComponent = class CountryComponent {
    ...
    getCountries() {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_3__["COUNTRY_API_URL"] + 'list';
        this.countryService.getCountries(url).subscribe(data => {
            this.countries = data;
        }, err => console.error(err), () => console.log('Countries retrieved from backend'));
