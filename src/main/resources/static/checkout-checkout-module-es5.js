...
var CartShippingAddress = /** @class */ (function () {
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(cartService, ngxSpinnerService, authService, userProfileService, cityService, stateService, countryService, addressTypeService, addressService, router, modalService) {
    ...
    CheckoutComponent.prototype.openModal = function (template, address) {
    ...
    CheckoutComponent.prototype.getMyCart = function () {
        var _this = this;
        this.ngxSpinnerService.show();
        var cartUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["CART_API_URL"] + 'find/user/' + this.authService.currentUserValue.id;
        this.cartService.getMyCart(cartUrl).subscribe(function (data) {
            ...
            _this.calculateTotalCost(_this.cartProducts);
            //this.checkAndHoldInventory();
            _this.getAddresses();
            _this.ngxSpinnerService.hide();
        });
    };
    CheckoutComponent.prototype.createOrder = function () {
    };
    CheckoutComponent.prototype.calculateTotalCost = function (cartProducts) {
        var totalCost = 0;
    ...
    CheckoutComponent.prototype.checkAndHoldInventory = function () {
    };
    CheckoutComponent.prototype.getAddresses = function () {
        var _this = this;
        var userProfileId = this.authService.currentUserSubject.value.userProfile.id;
        var userProfileUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["USER_PROFILE_API_URL"] + userProfileId;
        this.userProfileService.getUserProfile(userProfileUrl).subscribe(function (data) {
            _this.addresses = data.addresses;
        }, function (error1) {
            console.log('Failed to get User Profile information. Error: ' + error1);
        });
    };
    CheckoutComponent.prototype.changeShippingAddress = function (address) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var cartShippingAddressUrl, cartShippingAddress;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.ngxSpinnerService.show();
                        this.selectedShippingAddress = address;
                        cartShippingAddressUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["CART_ADDRESS_API_URL"] + 'add/shipping_address';
                        cartShippingAddress = new _cart_model_cart_shipping_address__WEBPACK_IMPORTED_MODULE_15__["CartShippingAddress"]();
                        ...
                        return [4 /*yield*/, this.cartService.changeShippingAddress(cartShippingAddressUrl, cartShippingAddress)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.getTaxRate(address.state.id)];
                    case 2:
                        _a.sent();
    ...
    CheckoutComponent.prototype.getTaxRate = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var taxRateUrl, taxRateObject;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        taxRateUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["TAX_RATE_API_URL"] + 'find/state/' + id;
                        return [4 /*yield*/, this.cartService.getTaxRate(taxRateUrl)];
                    case 1:
                        taxRateObject = _a.sent();
    ...
    CheckoutComponent.prototype.changeBillingAddress = function (address) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var cartBillingAddressUrl, cartBillingAddress;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.ngxSpinnerService.show();
                        this.selectedBillingAddress = address;
                        cartBillingAddressUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["CART_ADDRESS_API_URL"] + 'add/billing_address';
                        cartBillingAddress = new _cart_model_cart_shipping_address__WEBPACK_IMPORTED_MODULE_15__["CartShippingAddress"]();
                        ...
                        return [4 /*yield*/, this.cartService.changeBillingAddress(cartBillingAddressUrl, cartBillingAddress)];
                    case 1:
                        _a.sent();
                        this.ngxSpinnerService.hide();
                        return [2 /*return*/];
    ...
    CheckoutComponent.prototype.hideNewAddressDialog = function () {
        this.displayAddressDialog = false;
    };
    CheckoutComponent.prototype.updateUserAddress = function () {
        var _this = this;
        var addressApiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["ADDRESS_API_URL"] + 'update';
        this.addressService.updateAddress(addressApiUrl, this.addressForm.value).subscribe(function (data) {
            _this.getAddresses();
            _this.modalRef.hide();
        }, function (error1) {
    ...
    CheckoutComponent.prototype.deleteAddress = function (address) {
        var _this = this;
        if (confirm('Are you sure you want to delete the Address?')) {
            var addressUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["ADDRESS_API_URL"] + 'delete/' + address.id;
            this.addressService.deleteAddress(addressUrl).subscribe(function (data) {
                _this.getAddresses();
                _this.hideNewAddressDialog();
            }, function (error1) {
    ...
    CheckoutComponent.prototype.placeOrder = function () {
        var _this = this;
        this.ngxSpinnerService.show();
        var createOrderUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["ORDER_API_URL"] + 'create';
        this.cartService.createOrder(createOrderUrl, this.cart.id).subscribe(function (data) {
            _this.router.navigate(['/order']);
        }, function (error1) {
            console.log('Failed to create order');
        });
    };
    CheckoutComponent.prototype.loadAddressTypes = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["ADDRESS_TYPE_API_URL"] + 'list';
        this.addressTypeService.getAddressTypes(url).subscribe(function (addressTypes) {
    ...
    CheckoutComponent.prototype.loadCountries = function () {
        var _this = this;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["COUNTRY_API_URL"] + 'list';
        this.countryService.getCountries(url).subscribe(function (countries) {
            _this.countries = countries;
        }, function (error1) {
        });
    };
    CheckoutComponent.prototype.loadStates = function () {
        var _this = this;
        var country = this.addressForm.value.country;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["STATE_API_URL"] + 'find/country/' + country.id;
    ...
    CheckoutComponent.prototype.loadCities = function () {
        var _this = this;
        var state = this.addressForm.value.state;
        var url = _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVER_URL + _app_constants__WEBPACK_IMPORTED_MODULE_2__["CITY_API_URL"] + 'find/state/' + state.id;
    ...
    CheckoutComponent.prototype.cartDataAvailable = function () {
        return this.cart !== undefined && this.cart !== null && this.cartProducts.length >= 0;
    };
    CheckoutComponent.prototype.addressesAvailable = function () {
        return this.addresses !== undefined && this.addresses !== null && this.addresses.length >= 0;
    };
    CheckoutComponent.prototype.compareAddressTypeFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    CheckoutComponent.prototype.compareCountryFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    CheckoutComponent.prototype.compareStateFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    CheckoutComponent.prototype.compareCityFn = function (c1, c2) {
        return c1 && c2 ? c1.id === c2.id : c1 === c2;
    };
    CheckoutComponent.prototype.backToCart = function () {
