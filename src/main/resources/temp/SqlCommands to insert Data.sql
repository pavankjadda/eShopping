...
INSERT INTO spring_security_data.category VALUES(1002,'Grocery');
INSERT INTO spring_security_data.category VALUES(1003,'Electronics');
INSERT INTO spring_security_data.category VALUES(1001,'Books');


/* Insert Data into Product Table  */
INSERT INTO spring_security_data.product VALUES(2001,'iPhoneX',1003);
INSERT INTO spring_security_data.product VALUES(2002,'GalaxyS10',1003);
INSERT INTO spring_security_data.product VALUES(2003,'Google Pixel',1003);

/* Insert Data into Order Detail Table  */
INSERT INTO spring_security_data.order_detail VALUES(1,1001);

/* Insert Data into Order Detail Products Table  */
INSERT INTO spring_security_data.order_detail_productlist VALUES(1,1001,2001);
INSERT INTO spring_security_data.order_detail_productlist VALUES(2,1001,2002);
INSERT INTO spring_security_data.order_detail_productlist VALUES(3,1001,2002);
...
INSERT INTO `spring_security_data`.`user_role`(`id`,`user_id`,`role_id`) VALUES (1,2,1);
INSERT INTO `spring_security_data`.`user_role`(`id`,`user_id`,`role_id`) VALUES (2,1,2);
INSERT INTO `spring_security_data`.`user_role`(`id`,`user_id`,`role_id`) VALUES (3,1,1);
