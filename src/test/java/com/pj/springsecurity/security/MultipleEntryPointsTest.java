package com.pj.springsecurity.security;

import com.pj.springsecurity.SpringSecurityDataApplication;
...
@WebAppConfiguration
@SpringBootTest(classes = SpringSecurityDataApplication.class)
